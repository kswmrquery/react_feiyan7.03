...
class Myheader extends Component {
    ...
    render() {
        ...
        let feiyanChina_yeasterexist =  tot_new - this.props.feiyanChina_yestercure - this.props.feiyanChina_yesterdead;

        return (
            <div>
                <div className="headertitle">国内疫情</div>
                ...
                <div className="Myheader">
                        <div className="header_element">
                            ...
                            <div className="element_new">昨日 <span style={color1}> {feiyanChina_yeasterexist}</span></div>
                        </div>
                        <div className="header_element">
                        ...
                        <div className="header_element">
                            ...
                            <div className="element_new">昨日 <span style={color3}> {this.props.feiyanChina_yestercure}</span></div>
                        </div>
                        <div className="header_element">
                            <div className="element_title">累计死亡</div>
                            <div className="element_tot" style={color4}>{tot_dead}</div>
                            <div className="element_new">昨日 <span style={color4}> {this.props.feiyanChina_yesterdead}</span></div>
                        </div>
                </div>
            </div>
        )
